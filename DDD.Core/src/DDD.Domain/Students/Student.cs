...
public class Student : Entity
{
    ...
    public string Gender { get; set; }               // Gender of the student (Male, Female, etc.)
    ...
    public override PropertiesModel PropertiesModel
    {
        get
        {
            ...
            if (string.IsNullOrEmpty(this.Properties))
            {
                try
                {
                    propertiesModel = JsonConvert.DeserializeObject<StudentPropertiesModel>(this.Properties);
                }
                catch
                {
